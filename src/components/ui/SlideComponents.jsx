...
export function SlideCanvas({slide,themeIdx,compact=false}){
  const th=THEMES||THEMES;
  return(
    <div style={{background:th.bg,borderRadius:compact?6:12,padding:compact?"10px 14px":"22px 28px",aspectRatio:"16/9",display:"flex",flexDirection:"column",justifyContent:"center",position:"relative",overflow:"hidden",boxShadow:"0 6px 28px rgba(0,0,0,0.4)",width:"100%"}}>
      ...
      <div style={{position:"absolute",top:compact?7:12,right:compact?9:16,display:"flex",alignItems:"center",gap:4}}>
        <Logo size={compact?11:16}/><span style={{fontSize:compact?4:7,color:th.accent,fontWeight:800,letterSpacing:"0.15em"}}>VOLTARA</span>
      </div>
      <div style={{color:th.accent,fontSize:compact?5:8,fontWeight:800,letterSpacing:"0.18em",marginBottom:compact?3:7}}>PREMIUM CORPORATE</div>
...
// Aquí pega también FlipbookPreview y EngagementBars completos del código que me pasaste